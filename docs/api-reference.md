...
| Name | Type | Description |
|------|------|-------------|
| name | [```String```](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String) | The name of the parameter. *(Required)* |
| value | [```String```](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String) | The value of the parameter. *(Required)* |
| type | ```ParameterType``` | The type of the parameter. (See list below) *(Optional, default: ParameterType.Querystring)* |
...
| Name | Type | Description |
|------|------|-------------|
| type | ```VulnerabilityType``` | The built-in ```VulnerabilityType``` enum member value. Please see "How to get built-in ```VulnerabilityType``` enum values" below to learn more. *(Required)* |
| certainty | [```Number```](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number) | The certainty value of the vulnerability. Should be a number between 0 and 100. *(Required)* |
| confirmed | [```Boolean```](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean) | Specifies whether this vulnerability is a possible finding or a confirmed finding. *(Required)* |
...
| Name | Type | Description |
|------|------|-------------|
| guid | [```String```](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String) | The unique GUID value generated by the report policy editor. *(Required)* |
| certainty | [```Number```](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number) | The certainty value of the vulnerability. Should be a number between 0 and 100. *(Required)* |
| confirmed | [```Boolean```](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean) | Specifies whether this vulnerability is a possible finding or a confirmed finding. *(Required)* |
...
| Name | Type | Description |
|------|------|-------------|
| url | [```String```](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String) | The URL to perform request to. *(Required)* |
| rawRequest | [```String```](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String) | The string representation of the request headers and body (if exists). *(Required)* |
